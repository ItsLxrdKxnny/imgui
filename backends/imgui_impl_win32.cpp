...
//  2019-01-17: Misc: Using GetForegroundWindow()+IsChild() instead of FApplication::Get().GetWindow()->GetNativeWindowHandle() to be compatible with windows created in a different thread or parent.
